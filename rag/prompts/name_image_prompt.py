def get_name_and_image_template() -> str:
    """
    Restituisce il template del prompt per generare nome e immagine di un prodotto
    """
    return """
        ...
        6. Ragiona step by step in maniera minuziosa e estesa, ma **non scrivere gli step nella risposta**.
        ...
        - Se il nome inizia con “Esistono più possibili corrispondenze”, **non lasciare `image_url` vuoto**: inserisci il path dell'immagine del prodotto che hai scelto.
        </response_structure>
