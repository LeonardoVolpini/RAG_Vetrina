def get_image_template() -> str:
    """
    Restituisce il template del prompt per generare l'immagine di un prodotto
    """
    return """
        ...
        5. Ragiona step by step in maniera minuziosa e estesa, ma **non scrivere gli step nella risposta**.
